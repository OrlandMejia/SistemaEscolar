  ...
  <ul class="list-group">
    <?php foreach ($d as $m): ?>
      <li class="list-group-item">
        <a href="<?php echo sprintf('materias/ver/%s', $m->id_materia); ?>"><b><?php echo $m->materia; ?></b></a> impartida por <a href="<?php echo sprintf('profesores/ver/%s', $m->num_profesor); ?>"><b><?php echo $m->profesor; ?></b></a>
