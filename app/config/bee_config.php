...
define('BASEPATH'     , IS_LOCAL ? '/Sistema/SistemaEscolar/' : '____EL BASEPATH EN PRODUCCIÓN___'); // Debe ser cambiada a la ruta de tu proyecto en producción y desarrollo
