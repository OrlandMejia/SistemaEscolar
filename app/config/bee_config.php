...
define('BASEPATH'     , IS_LOCAL ? '/xampp content/colegio/Sistema/' : '____'); // Debe ser cambiada a la ruta de tu proyecto en producción y desarrollo
define('IS_DEMO'      , false);

// Set para conexión en producción o servidor real
define('DB_ENGINE'    , 'mysql');
define('DB_HOST'      , 'localhost');
define('DB_NAME'      , 'db_sistema_escolar');
define('DB_USER'      , 'root');
define('DB_PASS'      , '45479707');
